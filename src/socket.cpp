...
void Socket::connect_tcp(const std::string &host, const std::string &service, uint32_t timeout_sec) {
...
size_t Socket::read(char *rbuf, size_t capacity, uint32_t timeout_sec) {
    ...
    size_t rlen;
    async_read(socket_, boost::asio::buffer(rbuf, capacity), boost::asio::transfer_at_least(1),
