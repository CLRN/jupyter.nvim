...
// @param dot boolean
// @return string
auto Api::nvim__buf_debug_extmarks(integer buffer, boolean keys, boolean dot) -> promise<string> {}

// @private
// @param buffer integer
// @param first integer
// @param last integer
auto Api::nvim__buf_redraw_range(integer buffer, integer first, integer last) -> promise<void> {}

// @private
// @param buffer integer
// @return table<string,any>
auto Api::nvim__buf_stats(integer buffer) -> promise<table<string, any>> {}

// @private
// @return string
auto Api::nvim__get_lib_dir() -> promise<string> {}

// @private
// Find files in runtime directories
//
// @param pat std::vector<any> pattern of files to search for
...
auto Api::nvim__get_runtime(std::vector<any> pat, boolean all, table<string, any> opts)
...
// @return any
auto Api::nvim__id(any obj) -> promise<any> {}
...
// in plugins.
//
// @param arr std::vector<any> Array to return.
// @return std::vector<any>
auto Api::nvim__id_array(std::vector<any> arr) -> promise<std::vector<any>> {}
...
// @return table<string,any>
auto Api::nvim__id_dictionary(table<string, any> dct) -> promise<table<string, any>> {}
...
// @return number
auto Api::nvim__id_float(number flt) -> promise<number> {}
...
// @param col integer
// @return std::vector<any>
auto Api::nvim__inspect_cell(integer grid, integer row, integer col) -> promise<std::vector<any>> {}
...
//
auto Api::nvim__invalidate_glyph_cache() -> promise<void> {}

// @private
// @return std::vector<any>
auto Api::nvim__runtime_inspect() -> promise<std::vector<any>> {}

// @private
// @param path string
auto Api::nvim__screenshot(string path) -> promise<void> {}

// @private
// Gets internal stats.
//
// @return table<string,any>
auto Api::nvim__stats() -> promise<table<string, any>> {}

// @private
// @param str string
// @return any
auto Api::nvim__unpack(string str) -> promise<any> {}
...
//               output.
// @return string
auto Api::nvim_cmd(table<string, any> opts) -> promise<string> {}
